...
$(document).ready(function() {
	huan_id = $('#unique_id').text();
	huan_password = $('#unique').text();
	$('#unique_id').remove();
	$('#unique').remove();
	...
	function changeImgSize(x) {
		...
		_img.style.width = ((7.3 * 0.3937008 * my_dpi / Math.pow(1.259, N))/5)*temp + 'px';
		_img.style.height = ((7.3 * 0.3937008 * my_dpi / Math.pow(1.259, N))/5)*temp + 'px';
